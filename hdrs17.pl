...
# Define the names of the 17 HDRS items
my @items = (
...
my @valid_ranges = (
    4, 4, 4, 2, 2, 2, 4, 4, 4, 4, 4, 2, 2, 2, 4, 2, 4
);
...
# Main script
print "Hamilton Depression Rating Scale (HDRS-17) Scoring\n";
print "Please enter scores for each of the 17 items:\n";
