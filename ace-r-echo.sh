...
acer=$(echo $A1 + $A2 +  $A3 + $A4 + $M1 + $F1 + $F2 + $M2 + $M3 + $L0 + $L1+ $L2 + $L3 + $L4 + $L5 + $L6A + $L6 + $L7 + $L8 + $V1 + $V2 + $V3 + $V4 + $V5 + $M4 + $M5)
echo "The total ACE-R score is" $(($acer))"/100"
mmse=$(echo $A1 + $A2 + $A3 + $A4 + $M1 + $L0 + $L1 + $L2 + $L5 + $L6A + $V1) 
echo "The MMSE score is" $(($mmse)) "/30"
attention=$(echo $A1 + $A2 + $A3 + $A4) 
echo "The Attention subset score is" $(($attention)) "/18"
memory=$(echo $M1 + $M2 + $M3 + $M4 + $M5) 
echo "The memory subset score is" $(($memory)) "/26"
fluency=$(echo $F1 + $F2) 
echo "The Fluency subset score is" $(($fluency)) "/14"
language=$(echo $L1+ $L2 + $L3 + $L4 + $L5 + $L6 + $L7 + $L8) 
echo "The Language subset score is" $(($language)) "/26"
visuospatial=$(echo $V1 + $V2 + $V3 + $V4 + $V5) 
