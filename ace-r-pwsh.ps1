...
[int]$L5A = Read-Host -Prompt 'Please, enter value for object namin [0-2]'
while ($5A -gt 2 -OR $L5A -lt 0) {
$L5A = Read-Host "value is out of range, please re-type the value"
}
[int]$L5 = Read-Host -Prompt 'Please, enter value for object naming [0-10]'
while ($L5 -gt 10 -OR $L5 -lt 0) {
...
[int]$sum = [int]$A1 + [int]$A2 + [int]$A3 + [int]$A4 + [int]$M1 + [int]$F1 + [int]$F2 + [int]$M2 + [int]$M3 + [int]$L0 + [int]$L1 + [int]$L2 + [int]$L3 + [int]$L4 +  [int]$L5A + [int]$L5 + [int]$L6 + [int]$L7 + [int]$V1 + [int]$V2 + [int]$V3 + [int]$V4 + [int]$V5 + [int]$M4 + [int]$M5
Write-Host 'The total score of ACE-III is'$sum '/100'
[int]$mmse = [int]$A1 + [int]$A2 +[int]$A3 + [int]$A4 + [int]$M1 + [int]$L0 + [int]$L1 + [int]$L2 + [int]$L4 + [int]$L5A + [int]$LV1 
...
[int]$sumL = [int]$L1 + [int]$L2 + [int]$L3 + [int]$L4 +  [int]$L5A + [int]$L5 + [int]$L6 + [int]$L7
