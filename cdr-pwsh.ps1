...
[decimal]$P = Read-Host -Prompt '6. Please, type score for Personal Care'
...
[decimal]$CDR = [decimal]$M + [decimal]$O + [decimal]$J + [decimal]$C + [decimal]$H + [decimal]$P + [decimal]$B + [decimal]$L
write-host 'The total CDR-FTLD score is' $CDR '/24'
