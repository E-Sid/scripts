...
memory=$(echo $M1 + $M2 + $M3 + $M4 + $M5 + $M6) 
echo "The Memory score is" $(($memory))"/24"
orientation=$(echo $O7 + $O8 + $O9 + $O10 + $O11 + $O12 + $O13)
echo "The Orientation and Attention score is" $(($orientation)) "/28"
adls=$(echo $ADL14 + $ADL15 + $ADL16 + $ADL17 + $ADL18 + $ADL19 + $ADL20 + $ADL21) 
echo "The Activities of Daily Living score is" $(($adls))"/32"
selfcare=$(echo $SC22 + $SC23 + $SC24 + $SC25 + $SC26 + $SC27 + $SC28) 
echo "The Self Care score is" $(($selfcare))"/28"
mood=$(echo $MO29 + $MO30 + $MO31 + $MO32 + $MO33 + $MO34 + $MO35 + $MO36 + $MO37)
echo "The Mood score is" $(($mood))"/36"
belief=$(echo $B38 + $B39 + $B40 + $B41 +$B42 + $B43 + $B44) 
echo "The Beliefs score is" $(($belief))"/28"
behaviour=$(echo $CB45 + $CB46 + $CB47 + $CB48) 
echo "The Challenging Behaviour score is" $(($behaviour))"/16"
disinhibition=$(echo $D49 + $D50 + $D51 + $D52 + $D53) 
echo "The Disnihibition score is" $(($disinhibition))"/20"
eating=$(echo $E54 + $E55 + $E56 + $E57 + $E58)
echo "The Eating Habit score is" $(($eating))"/20"
sleep=$(echo $S59 + $S60) 
echo "The sleep score is" $(($sleep))"/8"
motor=$(echo $SMB61 + $SMB62 + $SMB63 + $SMB64 + $SMB65 + $SMB66 + $SMB67 + $SMB68 + $SMB69 + $SMB70 + $SMB71)
echo "The Stereotypic and Motor Behaviours score is" $(($motor))"/44"
motivation=$(echo $MTV72 + $MTV73 + $MTV74 + $MTV75 + $MTV76 + $MTV77 + $MTV78 + $MTV79) 
echo "The Motivation score is" $(($motivation))"/32"
insight=$(echo $I80 + $I81)
